...
function New-DistroShelfFedoraProvider {
    ...
    $terminalStages=@(
        (New-DistroShelfTerminalStage 'terminal-gnome-console' 'dnf' 'GNOME Console' 'gnome-console' 'kgx')
        (New-DistroShelfTerminalStage 'terminal-kitty' 'dnf' 'Kitty' 'kitty' 'kitty')
        (New-DistroShelfTerminalStage 'terminal-alacritty' 'dnf' 'Alacritty' 'alacritty' 'alacritty')
        (New-DistroShelfTerminalStage 'terminal-foot' 'dnf' 'Foot' 'foot' 'foot')
        (New-DistroShelfTerminalStage 'terminal-konsole' 'dnf' 'Konsole' 'konsole' 'konsole')
    )
